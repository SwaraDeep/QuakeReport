...
public final class QueryUtils {
    ...
    static String url;
    public static ArrayList<Item> extractEarthquakes() {
        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<Item> earthquakes = new ArrayList<>();
        String Place;
        String Speed;
        String LocationSeperator = " of ";
        ...
        try {
            ...
            for (int i = 0; i < earthQuakeArray.length(); i++) {
                ...
                if (location.contains(LocationSeperator)) {
                    String[] simplePlace = location.split(LocationSeperator);
                    Speed = simplePlace[0] + LocationSeperator;
                    Place = simplePlace[1];
                } else {
                    Speed = "Near the ";
                    Place = location;
                ...
                String FullTime = TimeFormat.format(date);

                Item ia = new Item(magnitude, Speed, Place, FullDate, FullTime, url);
                earthquakes.add(ia);
            }
