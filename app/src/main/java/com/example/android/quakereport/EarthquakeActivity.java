...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Earthquake>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnected) {
            ...
            mEmptyStateTextView.setText("Not connected to network");


        // Set an Earthquake click listener on the ListView, which sends an intent to a web browser
   ...
   /*   private class EarthquakeAsyncTask extends AsyncTask<String, Void, List<Earthquake>> {
      ...
      /*  @Override
         ...
         * which will trigger the ListView to re-populate its list Earthquakes.
         */
   /*     @Override
